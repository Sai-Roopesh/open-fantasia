...
CREATE TABLE public.chat_timeline_events (
    ...
    event_type text DEFAULT 'beat'::text NOT NULL,
    affected_entity_ids uuid[] DEFAULT '{}'::uuid[] NOT NULL,
    affected_relationship_ids uuid[] DEFAULT '{}'::uuid[] NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT chat_timeline_events_importance_check CHECK (((importance >= 1) AND (importance <= 5))),
    CONSTRAINT chat_timeline_events_event_type_check CHECK ((event_type = ANY (ARRAY['beat'::text, 'reveal'::text, 'betrayal'::text, 'discovery'::text, 'combat'::text, 'scene_change'::text, 'time_skip'::text, 'relationship_shift'::text, 'emotion_shift'::text, 'spatial_move'::text])))
);
...
CREATE TABLE public.world_snapshots (
    ...
    narrative_timestamp text DEFAULT ''::text NOT NULL,
    transition_type text DEFAULT 'continuation'::text NOT NULL,
    version integer DEFAULT 1 NOT NULL,
    is_full_materialization boolean DEFAULT false NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT world_snapshots_transition_type_check CHECK ((transition_type = ANY (ARRAY['continuation'::text, 'scene_transition'::text, 'time_skip'::text]))),
    CONSTRAINT world_snapshots_version_check CHECK ((version > 0))
);
...
CREATE TABLE public.world_entities (
    ...
    primary_emotion text DEFAULT 'neutral'::text NOT NULL,
    emotion_intensity integer DEFAULT 5 NOT NULL,
    emotion_catalyst text DEFAULT ''::text NOT NULL,
    valid_from_turn_id uuid NOT NULL,
    invalidated_at_turn_id uuid,
    t_created timestamp with time zone DEFAULT now() NOT NULL,
    t_expired timestamp with time zone,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT world_entities_entity_type_check CHECK ((entity_type = ANY (ARRAY['character'::text, 'npc'::text, 'creature'::text, 'object'::text, 'group'::text]))),
    CONSTRAINT world_entities_emotion_intensity_check CHECK (((emotion_intensity >= 1) AND (emotion_intensity <= 10)))
);


--
-- Name: world_entity_facts; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.world_entity_facts (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    entity_id uuid NOT NULL,
    thread_id uuid NOT NULL,
    branch_id uuid NOT NULL,
    fact_type text DEFAULT 'knowledge'::text NOT NULL,
    body text NOT NULL,
    valid_from_turn_id uuid NOT NULL,
    invalidated_at_turn_id uuid,
    t_created timestamp with time zone DEFAULT now() NOT NULL,
    t_expired timestamp with time zone,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT world_entity_facts_fact_type_check CHECK ((fact_type = ANY (ARRAY['knowledge'::text, 'trait'::text, 'goal'::text, 'secret'::text, 'ability'::text, 'possession'::text])))
);
...
CREATE TABLE public.world_relationships (
    ...
    relationship_type text DEFAULT 'social'::text NOT NULL,
    dynamic_status text NOT NULL,
    valid_from_turn_id uuid NOT NULL,
    invalidated_at_turn_id uuid,
    t_created timestamp with time zone DEFAULT now() NOT NULL,
    t_expired timestamp with time zone,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT world_relationships_relationship_type_check CHECK ((relationship_type = ANY (ARRAY['social'::text, 'romantic'::text, 'familial'::text, 'professional'::text, 'adversarial'::text, 'alliance'::text, 'other'::text])))
);
...
--
-- Name: world_location_edges; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.world_location_edges (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    thread_id uuid NOT NULL,
    branch_id uuid NOT NULL,
...
--
-- Name: world_entity_placements; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.world_entity_placements (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    thread_id uuid NOT NULL,
    branch_id uuid NOT NULL,
    entity_id uuid NOT NULL,
    location_id uuid NOT NULL,
    micro_position text DEFAULT ''::text NOT NULL,
    valid_from_turn_id uuid NOT NULL,
    invalidated_at_turn_id uuid,
    t_created timestamp with time zone DEFAULT now() NOT NULL,
    t_expired timestamp with time zone,
...
--
-- Name: world_narrative_threads; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.world_narrative_threads (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    thread_id uuid NOT NULL,
    branch_id uuid NOT NULL,
    ...
    t_expired timestamp with time zone,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT world_narrative_threads_status_check CHECK ((status = ANY (ARRAY['open'::text, 'blocked'::text, 'resolving'::text, 'resolved'::text])))
);
...
ALTER TABLE ONLY public.world_snapshots
    ADD CONSTRAINT world_snapshots_pkey PRIMARY KEY (turn_id);
...
--
-- Name: world_entity_facts world_entity_facts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_entity_facts
    ADD CONSTRAINT world_entity_facts_pkey PRIMARY KEY (id);
...
--
-- Name: world_location_edges world_location_edges_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_location_edges
    ADD CONSTRAINT world_location_edges_pkey PRIMARY KEY (id);


--
-- Name: world_entity_placements world_entity_placements_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_entity_placements
    ADD CONSTRAINT world_entity_placements_pkey PRIMARY KEY (id);


--
-- Name: world_narrative_threads world_narrative_threads_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_narrative_threads
    ADD CONSTRAINT world_narrative_threads_pkey PRIMARY KEY (id);
...
--
-- Name: world_snapshots_branch_updated_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX world_snapshots_branch_updated_idx ON public.world_snapshots USING btree (branch_id, updated_at DESC);


--
-- Name: world_entities_thread_branch_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX world_entities_thread_branch_idx ON public.world_entities USING btree (thread_id, branch_id);


--
-- Name: world_entities_valid_from_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX world_entities_valid_from_idx ON public.world_entities USING btree (valid_from_turn_id);


--
-- Name: world_entity_facts_entity_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX world_entity_facts_entity_idx ON public.world_entity_facts USING btree (entity_id, branch_id);


--
-- Name: world_relationships_thread_branch_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX world_relationships_thread_branch_idx ON public.world_relationships USING btree (thread_id, branch_id);


--
-- Name: world_locations_thread_branch_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX world_locations_thread_branch_idx ON public.world_locations USING btree (thread_id, branch_id);


--
-- Name: world_location_edges_thread_branch_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX world_location_edges_thread_branch_idx ON public.world_location_edges USING btree (thread_id, branch_id);


--
-- Name: world_entity_placements_thread_branch_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX world_entity_placements_thread_branch_idx ON public.world_entity_placements USING btree (thread_id, branch_id);


--
-- Name: world_narrative_threads_thread_branch_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX world_narrative_threads_thread_branch_idx ON public.world_narrative_threads USING btree (thread_id, branch_id);
...
--
-- Name: chat_threads chat_threads_brain_connection_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.chat_threads
    ADD CONSTRAINT chat_threads_brain_connection_id_fkey FOREIGN KEY (brain_connection_id) REFERENCES public.ai_connections(id) ON DELETE SET NULL;


--
-- Name: world_snapshots world_snapshots_based_on_turn_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_snapshots
    ADD CONSTRAINT world_snapshots_based_on_turn_id_fkey FOREIGN KEY (based_on_turn_id) REFERENCES public.chat_turns(id) ON DELETE SET NULL;


--
-- Name: world_snapshots world_snapshots_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_snapshots
    ADD CONSTRAINT world_snapshots_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.chat_branches(id) ON DELETE CASCADE;


--
-- Name: world_snapshots world_snapshots_thread_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_snapshots
    ADD CONSTRAINT world_snapshots_thread_id_fkey FOREIGN KEY (thread_id) REFERENCES public.chat_threads(id) ON DELETE CASCADE;


--
-- Name: world_snapshots world_snapshots_turn_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_snapshots
    ADD CONSTRAINT world_snapshots_turn_id_fkey FOREIGN KEY (turn_id) REFERENCES public.chat_turns(id) ON DELETE CASCADE;


--
-- Name: world_entities world_entities_thread_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_entities
    ADD CONSTRAINT world_entities_thread_id_fkey FOREIGN KEY (thread_id) REFERENCES public.chat_threads(id) ON DELETE CASCADE;


--
-- Name: world_entities world_entities_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_entities
    ADD CONSTRAINT world_entities_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.chat_branches(id) ON DELETE CASCADE;


--
-- Name: world_entities world_entities_character_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_entities
    ADD CONSTRAINT world_entities_character_id_fkey FOREIGN KEY (character_id) REFERENCES public.characters(id) ON DELETE SET NULL;


--
-- Name: world_entities world_entities_valid_from_turn_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_entities
    ADD CONSTRAINT world_entities_valid_from_turn_id_fkey FOREIGN KEY (valid_from_turn_id) REFERENCES public.chat_turns(id) ON DELETE CASCADE;


--
-- Name: world_entities world_entities_invalidated_at_turn_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_entities
    ADD CONSTRAINT world_entities_invalidated_at_turn_id_fkey FOREIGN KEY (invalidated_at_turn_id) REFERENCES public.chat_turns(id) ON DELETE SET NULL;


--
-- Name: world_entity_facts world_entity_facts_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_entity_facts
    ADD CONSTRAINT world_entity_facts_entity_id_fkey FOREIGN KEY (entity_id) REFERENCES public.world_entities(id) ON DELETE CASCADE;


--
-- Name: world_entity_facts world_entity_facts_thread_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_entity_facts
    ADD CONSTRAINT world_entity_facts_thread_id_fkey FOREIGN KEY (thread_id) REFERENCES public.chat_threads(id) ON DELETE CASCADE;


--
-- Name: world_entity_facts world_entity_facts_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_entity_facts
    ADD CONSTRAINT world_entity_facts_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.chat_branches(id) ON DELETE CASCADE;


--
-- Name: world_entity_facts world_entity_facts_valid_from_turn_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_entity_facts
    ADD CONSTRAINT world_entity_facts_valid_from_turn_id_fkey FOREIGN KEY (valid_from_turn_id) REFERENCES public.chat_turns(id) ON DELETE CASCADE;


--
-- Name: world_relationships world_relationships_thread_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_relationships
    ADD CONSTRAINT world_relationships_thread_id_fkey FOREIGN KEY (thread_id) REFERENCES public.chat_threads(id) ON DELETE CASCADE;


--
-- Name: world_relationships world_relationships_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_relationships
    ADD CONSTRAINT world_relationships_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.chat_branches(id) ON DELETE CASCADE;


--
-- Name: world_relationships world_relationships_source_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_relationships
    ADD CONSTRAINT world_relationships_source_entity_id_fkey FOREIGN KEY (source_entity_id) REFERENCES public.world_entities(id) ON DELETE CASCADE;


--
-- Name: world_relationships world_relationships_target_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_relationships
    ADD CONSTRAINT world_relationships_target_entity_id_fkey FOREIGN KEY (target_entity_id) REFERENCES public.world_entities(id) ON DELETE CASCADE;


--
-- Name: world_locations world_locations_thread_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_locations
    ADD CONSTRAINT world_locations_thread_id_fkey FOREIGN KEY (thread_id) REFERENCES public.chat_threads(id) ON DELETE CASCADE;


--
-- Name: world_locations world_locations_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_locations
    ADD CONSTRAINT world_locations_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.chat_branches(id) ON DELETE CASCADE;


--
-- Name: world_location_edges world_location_edges_thread_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_location_edges
    ADD CONSTRAINT world_location_edges_thread_id_fkey FOREIGN KEY (thread_id) REFERENCES public.chat_threads(id) ON DELETE CASCADE;


--
-- Name: world_location_edges world_location_edges_from_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_location_edges
    ADD CONSTRAINT world_location_edges_from_location_id_fkey FOREIGN KEY (from_location_id) REFERENCES public.world_locations(id) ON DELETE CASCADE;


--
-- Name: world_location_edges world_location_edges_to_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_location_edges
    ADD CONSTRAINT world_location_edges_to_location_id_fkey FOREIGN KEY (to_location_id) REFERENCES public.world_locations(id) ON DELETE CASCADE;


--
-- Name: world_entity_placements world_entity_placements_thread_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_entity_placements
    ADD CONSTRAINT world_entity_placements_thread_id_fkey FOREIGN KEY (thread_id) REFERENCES public.chat_threads(id) ON DELETE CASCADE;


--
-- Name: world_entity_placements world_entity_placements_entity_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_entity_placements
    ADD CONSTRAINT world_entity_placements_entity_id_fkey FOREIGN KEY (entity_id) REFERENCES public.world_entities(id) ON DELETE CASCADE;


--
-- Name: world_entity_placements world_entity_placements_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_entity_placements
    ADD CONSTRAINT world_entity_placements_location_id_fkey FOREIGN KEY (location_id) REFERENCES public.world_locations(id) ON DELETE CASCADE;


--
-- Name: world_narrative_threads world_narrative_threads_thread_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_narrative_threads
    ADD CONSTRAINT world_narrative_threads_thread_id_fkey FOREIGN KEY (thread_id) REFERENCES public.chat_threads(id) ON DELETE CASCADE;


--
-- Name: world_narrative_threads world_narrative_threads_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.world_narrative_threads
    ADD CONSTRAINT world_narrative_threads_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.chat_branches(id) ON DELETE CASCADE;
...
--
-- Name: world_snapshots; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: world_entity_facts; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.world_entity_facts ENABLE ROW LEVEL SECURITY;

--
-- Name: world_relationships; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.world_relationships ENABLE ROW LEVEL SECURITY;

--
-- Name: world_locations; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.world_locations ENABLE ROW LEVEL SECURITY;

--
-- Name: world_location_edges; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.world_location_edges ENABLE ROW LEVEL SECURITY;

--
-- Name: world_entity_placements; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.world_entity_placements ENABLE ROW LEVEL SECURITY;

--
-- Name: world_narrative_threads; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: world_snapshots world_snapshots_own_thread; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY world_snapshots_own_thread ON public.world_snapshots USING (public.owns_thread(thread_id)) WITH CHECK (public.owns_thread(thread_id));


--
-- Name: world_entities world_entities_own_thread; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY world_entities_own_thread ON public.world_entities USING (public.owns_thread(thread_id)) WITH CHECK (public.owns_thread(thread_id));


--
-- Name: world_entity_facts world_entity_facts_own_thread; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY world_entity_facts_own_thread ON public.world_entity_facts USING (public.owns_thread(thread_id)) WITH CHECK (public.owns_thread(thread_id));


--
-- Name: world_relationships world_relationships_own_thread; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY world_relationships_own_thread ON public.world_relationships USING (public.owns_thread(thread_id)) WITH CHECK (public.owns_thread(thread_id));


--
-- Name: world_locations world_locations_own_thread; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY world_locations_own_thread ON public.world_locations USING (public.owns_thread(thread_id)) WITH CHECK (public.owns_thread(thread_id));


--
-- Name: world_location_edges world_location_edges_own_thread; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY world_location_edges_own_thread ON public.world_location_edges USING (public.owns_thread(thread_id)) WITH CHECK (public.owns_thread(thread_id));


--
-- Name: world_entity_placements world_entity_placements_own_thread; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY world_entity_placements_own_thread ON public.world_entity_placements USING (public.owns_thread(thread_id)) WITH CHECK (public.owns_thread(thread_id));


--
-- Name: world_narrative_threads world_narrative_threads_own_thread; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY world_narrative_threads_own_thread ON public.world_narrative_threads USING (public.owns_thread(thread_id)) WITH CHECK (public.owns_thread(thread_id));
