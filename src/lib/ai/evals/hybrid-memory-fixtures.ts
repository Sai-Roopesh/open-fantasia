...
export const hybridMemoryEvalFixtures: HybridMemoryEvalCase[] = [
  {
    ...
    snapshot: makeSnapshot({
      ...
      entity_state: [
        {
          ...
          aliases: [],
          knowledge_boundary: [{ id: "f1", body: "Ash's brother sold the route to the crown." }],
          traits: [{ id: "f2", body: "smuggler" }],
          goals: [],
          secrets: [],
          abilities: [],
          possessions: [],
      ...
      narrative_state: {
        active_threads: [{ thread_id: "nt_1", objective: "Escape the clocktower before the hunters reach the upper stair.", status: "open", dependencies: [] }],
  ...
  },
  {
    ...
    snapshot: makeSnapshot({
      ...
      narrative_state: {
        active_threads: [{ thread_id: "nt_2", objective: "Break the emotional stalemate.", status: "open", dependencies: [] }],
        resolved_threads: [],
      },
    }),
    turns: [
  ...
  },
  {
    ...
    snapshot: makeSnapshot({
      ...
      narrative_state: {
        active_threads: [{ thread_id: "nt_3", objective: "Choose the tunnel route before the wardens catch up.", status: "open", dependencies: [] }],
