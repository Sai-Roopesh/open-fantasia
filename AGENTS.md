...
- The migration history is squashed into a single consolidated `supabase/migrations/0001_baseline.sql`, regenerated from the live schema; the remote ledger records only `0001`. The baseline folds in everything the former incremental migrations did.
